    ...
    <div>
      ...
      <div className=" my-10 w-full px-3 lg:px-0 flex items-center justify-center">
        <div className=" w-full lg:w-1/3 new_class p-4">
          ...
          <h5 className=" font-semibold text-xs w-full text-center">Geo-location Data</h5>
          ...
          <h5 className=" font-semibold text-xs w-full text-center">E-mail marketing practices</h5>
          <p className=" pb-2 text-xs font-medium text-center">
          ...
          <h5 className=" font-semibold text-xs w-full text-center">Contacting Us</h5>
          <p className=" pb-2 text-xs font-medium text-center">
